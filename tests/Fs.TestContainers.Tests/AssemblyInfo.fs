...
[<assembly: AssemblyTitleAttribute("Fs.TestContainers.Tests")>]
[<assembly: AssemblyProductAttribute("Fs.TestContainers")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Fs.TestContainers.Tests"
    let [<Literal>] AssemblyProduct = "Fs.TestContainers"
